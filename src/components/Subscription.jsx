  ...
  return (
    <>
      ...
      <div className="w-full flex justify-center">
        {/* left */}
        <div className=" flex jusstify-center items-center size-1/2 bg-light-pink h-[580px]">
          <div className='mx-auto'>
            <div className="p-5 text-4xl text-slate-500 font-bold m-2 font-[Geist]">Набор Lite</div>
            <div className='z-10 relative  '>
              <img src={price1} alt="price" className='absolute xl:left-64 xl:-top-16 md:left-36 md:-top-16' />
            </div>
            <div className="xl:w-[440px] p-10 shadow-slate-200 shadow-lg xl:h-[300px] rounded-2xl bg-white"> 
              ...
              <button className="text-sm p-5 m-4 mt-16 font-[Roboto] font-normal bg-light-purple rounded-xl text-white">
                Заказать
              </button>
            </div>  
          </div>
        ...
        <div className=" flex jusstify-center items-center size-1/2 bg-light-purple h-[580px]">
          <div className='mx-auto'>
            ...
            <div className='z-10 relative  '>
              <img src={price2} alt="price" className='absolute xl:left-64 xl:-top-24 md:left-36 md:-top-24' />
            </div>

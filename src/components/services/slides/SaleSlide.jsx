...
import shop from '/src/assets/services/shop.png';
import phone from '/src/assets/services/phone.png';
	...
	return (
		<div className='flex items-start justify-between w-full h-full mb-10 pl-21'>
			<div className='w-1/2 flex flex-col items-start justify-start pt-20'>
				<img src={shop} alt='shop' className='h-[83px] w-[83px]'/>
			...
			<div className='w-1/2 bg-[#F3F5FF] absolute right-0 h-full'>
				<img src={phone} alt="phone" className='relative h-[60%] top-[120px] -left-[30px]'/>
			</div>
		</div>
	);
};

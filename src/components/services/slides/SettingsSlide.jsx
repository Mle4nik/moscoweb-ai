...
const SettingsSlide = () => {
	return (
	<div className='flex items-start justify-between w-full h-full mb-12.5 pl-21'>
		<div className='w-1/2 flex flex-col items-start justify-start pt-20'>
			...
			<ul className='flex flex-col font-[Roboto-Regular] mt-10 pl-8 text-[25px]'>
			...
			<ul className='flex flex-col font-[Roboto-Regular] pl-8 text-[25px] mt-4.5'>
		...
		<div className='w-1/2 bg-[#F3F5FF] absolute right-0 h-full'>
			<img src="/src/assets/services/botillustration.png" alt="botillustration" className='relative top-[192px] -left-[156px]'/>
		</div>
	</div>
	);
};

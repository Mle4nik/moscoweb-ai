                    ...
                    {serviceItems?.map((item) => {
                        return (
                            <button key={item.title}
                                    className={`${activeTitle === item.title ? 'bg-[#E0E6FF]' : 'hover:bg-[#F3F5FF]'} transition flex item-center justify-center py-2.5 px-7.5 border-2 border-[#F3F5FF] rounded-full min-w-max text-center text-[#4457FF] text-[22px]`}

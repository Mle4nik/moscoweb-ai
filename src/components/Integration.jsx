      ...
      <div className="flex justify-center items-center">
        ...
        <div className="w-full flex justify-center my-6 space-x-16">
          <div className="size-1/5">
            ...
            <div className=" text-slate-500 text-xl font-semibold font-[Montserrat]">
        ...
        <div>
          <div className="mt-32 mb-12 font-bold text-5xl text-center font-[Geist] ">
            А еще у нас есть
          </div>
        </div>
        ...
        <div>
          <div className="flex flex-col mx-12 mb-32">
            <div className="w-full shadow-[0_0_60px_-20px_rgba(0,0,0,0.2)] rounded-3xl flex items-start p-9 mb-6">
              ...
              <div>
                <h4 className="text-2xl mb-2 font-[Geist] font-black tracking-wide">
                  Прямая интеграция с GPT
                </h4>
                <p className="text-[#7C7E9D] text-lg font-bold font-[Montserrat] tracking-wide">
